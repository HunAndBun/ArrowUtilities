...
namespace ArrowUtilities.Serialization {
    ...
    public static class SerializableVectorHelpers {
        /// <summary>
        ///     <para>
        ///         Method for easily prepping Vector2 structs for JSON serialization.
        ///         <br /><b>Note: The same can be done in reverse with ".ToVector2()"</b>
        ///     </para>
        /// </summary>
        ...
        /// <summary>
        ///     <para>
        ///         Method for easily prepping Vector2Int structs for JSON serialization.
        ///         <br /><b>Note: The same can be done in reverse with ".ToVector2Int()"</b>
        ///     </para>
        /// </summary>
        ...
        /// <summary>
        ///     <para>
        ///         Method for easily prepping Vector3 structs for JSON serialization.
        ///         <br /><b>Note: The same can be done in reverse with ".ToVector3()"</b>
        ///     </para>
        /// </summary>
        ...
        /// <summary>
        ///     <para>
        ///         Method for easily prepping Vector3Int structs for JSON serialization.
        ///         <br /><b>Note: The same can be done in reverse with ".ToVector3Int()"</b>
        ///     </para>
        /// </summary>
